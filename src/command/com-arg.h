...
{
public:
   IterationLoop(_comptr& com, _fcptr& ctx, pp_perun2& p2);
...
{
public:
   CS_StringComArg(_genptr<p_str>& str, _comptr& com, _fcptr& ctx, pp_perun2& p2);
   void run() override;
...
{
public:
   CS_ListComArg(_genptr<p_list>& li, _comptr& com, _fcptr& ctx, pp_perun2& p2);
   void run() override;
...
{
public:
   CS_DefinitionComArg(p_defptr& def, _comptr& com, _fcptr& ctx, pp_perun2& p2);
   void run() override;
