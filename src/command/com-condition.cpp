...
If_Base::If_Base(_genptr<p_bool>& cond, _comptr& com)
   : condition(std::move(cond)), mainCommand(std::move(com)) { }


If_Raw::If_Raw(_genptr<p_bool>& cond, _comptr& com)
   : If_Base(cond, com) { }
...
If_Else::If_Else(_genptr<p_bool>& cond, _comptr& com, _comptr& alt)
...
If_ElseIf::If_ElseIf(_genptr<p_bool>& cond, _comptr& com, _genptr<p_bool>& altCond, _comptr& alt)
...
If_ElseIfElse::If_ElseIfElse(_genptr<p_bool>& cond, _comptr& com, _genptr<p_bool>& altCond, _comptr& alt, _comptr& els)
...
If_ManyAlternatives::If_ManyAlternatives(_genptr<p_bool>& cond, _comptr& com,
...
If_Alts::If_Alts(_genptr<p_bool>& cond, _comptr& com, std::vector<_genptr<p_bool>>& altConds,
...
If_AltsElse::If_AltsElse(_genptr<p_bool>& cond, _comptr& com, std::vector<_genptr<p_bool>>& altConds,
