...
{
public:
   C_TimeAlter(_genptr<_tim>& ti, const p_bool save, FileContext* ctx, p_perun2& p2)
...
{
   C_ReaccessTo(_genptr<_tim>& ti, const p_bool save, FileContext* ctx, p_perun2& p2)
...
{
   C_RechangeTo(_genptr<_tim>& ti, const p_bool save, FileContext* ctx, p_perun2& p2)
      : C_TimeAlter(ti, save, ctx, p2) { };
...
{
   C_RecreateTo(_genptr<_tim>& ti, const p_bool save, FileContext* ctx, p_perun2& p2)
      : C_TimeAlter(ti, save, ctx, p2) { };
...
{
   C_RemodifyTo(_genptr<_tim>& ti, const p_bool save, FileContext* ctx, p_perun2& p2)
      : C_TimeAlter(ti, save, ctx, p2) { };
