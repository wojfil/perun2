...
{
public:
   F_CountInside(p_defptr& def, _lcptr& lctx, FileContext* fctx, pp_perun2& p2)
...
{
public:
   F_RandomNumber(_genptr<p_num>& a1, pp_perun2& p2)
...
public:
   F_Count() = delete;
   F_Count(p_defptr& def, pp_perun2& p2) 
