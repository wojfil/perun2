...
{
public:
   LocationReference(pp_perun2& p2);
   p_str getValue() override;
...
{
public:
   RelativeLocation(_genptr<p_str>& val, pp_perun2& p2, const p_int retr);
   p_str getValue() override;
...
{
public:
   DefinitionElement(p_defptr& def, _genptr<p_num>& ind, pp_perun2& p2)
