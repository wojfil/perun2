...
#include "../../include/perun2/datatype/order-limit-one.hpp"

namespace perun2::gen
{

OrderByLimitOne::OrderByLimitOne(p_defptr& bas, FileContext* ctx, p_fcptr& nextCtx, p_loptr& lo, Perun2Process& p2)
