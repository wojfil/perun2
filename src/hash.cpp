...
Hashes::Hashes() :
   ...
   HASH_VAR_DEVICE(rawStringHash(STRING_DEVICE)),
   HASH_VAR_ROOT(rawStringHash(STRING_ROOT)),
   ...
   HASH_VAR_FILE(rawStringHash(STRING_FILE)),
   HASH_VAR_DIRECTORY(rawStringHash(STRING_DIRECTORY)),
   ...
   HASH_FUNC_EXIST(rawStringHash(STRING_EXIST)),
   HASH_FUNC_ANY(rawStringHash(STRING_ANY)),
   ...
   HASH_FUNC_COUNT(rawStringHash(STRING_COUNT)),
   ...
   HASH_GROUP_VARS_IMMUTABLES({
      this->HASH_VAR_THIS, this->HASH_VAR_ACCESS,
   this->HASH_VAR_ARCHIVE,
   this->HASH_VAR_CHANGE,
   this->HASH_VAR_COMPRESSED,
   this->HASH_VAR_CREATION,
   this->HASH_VAR_DEPTH,
   this->HASH_VAR_DRIVE,
   this->HASH_VAR_EMPTY,
   this->HASH_VAR_ENCRYPTED,
   this->HASH_VAR_EXISTS,
   this->HASH_VAR_EXTENSION,
   this->HASH_VAR_FULLNAME,
   this->HASH_VAR_HIDDEN,
   this->HASH_VAR_INDEX,
   this->HASH_VAR_ISDIRECTORY,
   this->HASH_VAR_ISFILE,
   this->HASH_VAR_LIFETIME,
   this->HASH_VAR_LOCATION,
   this->HASH_VAR_MODIFICATION,
   this->HASH_VAR_NAME,
   this->HASH_VAR_PARENT,
   this->HASH_VAR_PATH,
   this->HASH_VAR_READONLY,
   this->HASH_VAR_SIZE,
   this->HASH_VAR_SUCCESS,
   this->HASH_VAR_NOW,
   this->HASH_VAR_TODAY,
   this->HASH_VAR_YESTERDAY,
   this->HASH_VAR_TOMORROW,
   this->HASH_VAR_JANUARY,
   this->HASH_VAR_FEBRUARY,
   this->HASH_VAR_MARCH,
   this->HASH_VAR_APRIL,
   this->HASH_VAR_MAY,
   this->HASH_VAR_JUNE,
   this->HASH_VAR_JULY,
   this->HASH_VAR_AUGUST,
   this->HASH_VAR_SEPTEMBER,
   this->HASH_VAR_OCTOBER,
   this->HASH_VAR_NOVEMBER,
   this->HASH_VAR_DECEMBER,
   this->HASH_VAR_MONDAY,
   this->HASH_VAR_TUESDAY,
   this->HASH_VAR_WEDNESDAY,
   this->HASH_VAR_THURSDAY,
   this->HASH_VAR_FRIDAY,
   this->HASH_VAR_SATURDAY,
   this->HASH_VAR_SUNDAY,
   this->HASH_VAR_ALPHABET,
   this->HASH_VAR_ASCII,
   this->HASH_VAR_ARGUMENTS,
   this->HASH_VAR_DESKTOP,
   this->HASH_VAR_UROBOROS2,
   this->HASH_VAR_DEVICE,
   this->HASH_VAR_ROOT,
   this->HASH_VAR_DIRECTORIES,
   this->HASH_VAR_FILES,
   this->HASH_VAR_RECURSIVEFILES,
   this->HASH_VAR_RECURSIVEDIRECTORIES
