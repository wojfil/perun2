...
public:
   ...
   const _size HASH_KW_COPY;
   const _size HASH_KW_CREATE;
   const _size HASH_KW_DELETE;
   const _size HASH_KW_DOWNLOAD;
   const _size HASH_KW_DROP;
   const _size HASH_KW_HIDE;
   const _size HASH_KW_LOCK;
   const _size HASH_KW_MOVE;
   const _size HASH_KW_OPEN;
   const _size HASH_KW_REACCESS;
   const _size HASH_KW_RECREATE;
   const _size HASH_KW_RECHANGE;
   const _size HASH_KW_REMODIFY;
   const _size HASH_KW_RENAME;
   const _size HASH_KW_SELECT;
   const _size HASH_KW_UNHIDE;
   const _size HASH_KW_UNLOCK;
   const _size HASH_KW_FORCE;
   const _size HASH_KW_STACK;
   const _size HASH_KW_TRUE;
   const _size HASH_KW_FALSE;
   const _size HASH_KW_AND;
   const _size HASH_KW_OR;
   const _size HASH_KW_XOR;
   const _size HASH_KW_NOT;
   const _size HASH_KW_PRINT;
   const _size HASH_KW_RUN;
   const _size HASH_KW_SLEEP;
   const _size HASH_KW_IN;
   const _size HASH_KW_LIKE;
   const _size HASH_KW_ELSE;
   const _size HASH_KW_IF;
   const _size HASH_KW_INSIDE;
   const _size HASH_KW_TIMES;
   const _size HASH_KW_WHILE;
   const _size HASH_KW_EVERY;
   const _size HASH_KW_FINAL;
   const _size HASH_KW_LIMIT;
   const _size HASH_KW_ORDER;
   const _size HASH_KW_SKIP;
   const _size HASH_KW_WHERE;
   const _size HASH_KW_AS;
   const _size HASH_KW_BY;
   const _size HASH_KW_FROM;
   const _size HASH_KW_TO;
   const _size HASH_KW_EXTENSIONLESS;
   const _size HASH_KW_WITH;
   const _size HASH_KW_ASC;
   const _size HASH_KW_DESC;
   const _size HASH_KW_BREAK;
   const _size HASH_KW_CONTINUE;
   const _size HASH_KW_EXIT;
   const _size HASH_KW_ERROR;
