...
_const _str OS_SEPARATOR_STRING = toStr(OS_SEPARATOR);
_const _str OS_SEPARATOR_ASTERISK = str(OS_SEPARATOR_STRING, STRING_CHAR_ASTERISK);
_const _str OS_SEPARATOR_APOSTROPHE = str(OS_SEPARATOR_STRING, STRING_CHAR_APOSTROPHE);

_const _str OS_GIT_DIRECTORY = str(STRING_CHAR_DOT, STRING_GIT);
_const _str OS_SVN_DIRECTORY = str(STRING_CHAR_DOT, STRING_SVN);
