...
runTestCase("print before('', 'a')", EMPTY_STRING)
runTestCase("print before(2103, 1)", "21")
...
runTestCase("print path('some', 'relative', 'path')", path("some", "relative", "relative"))
runTestCase("print path('c:/', 'absolute', 'path')", path("c:", "absolute", "relative"))
...
runTestCase("print string('')", EMPTY_STRING)
