...
if __name__ == '__main__':
  ...
  run_test_case("print true and true xor false", "1")
  run_test_case("print true and true xor not false", "0")
  run_test_case("print true or true xor true", "0")
  run_test_case("print not false and true xor false", "1")
  run_test_case("print not false or not true xor true", "0")
  run_test_case("print (2*4)+(6*8)", "56")
  run_test_case("print -((2*4)+(6*8))+156", "100")
  run_test_case("print 2*2+-3*3", "-5")
  run_test_case("print 2<3", "1")
  run_test_case("print 2 < 2 or 3 != 34", "1")
  run_test_case("print 2*2<3; 14 = 2*7", lines("0", "1"))
  run_test_case("print 2<=2; 2<2; 1>=3;10 > 16", lines("1", "0", "0", "0"))
  run_test_case("print 2+2 = 4", "1")
  run_test_case("print 2+2 = 4.00003", "0")
  run_test_case("print 2+2 = 3.5 + 0.5", "1")
  run_test_case("print 2+2 < 4 - 0.0", "0")
  run_test_case("print 2+2 = 4 - 0.0", "1")
  run_test_case("print 2+2 = 4 - 0.0", "1")
  run_test_case("print 2+2 < 4 - 0.0", "0")
  run_test_case("print 'abc' = 'abc' ", "1")
  run_test_case("print 'abc' = 'abd' ", "0")
  run_test_case("print 'abc' < 'abc' ", "0")
  run_test_case("print 'abc' <= 'abc' ", "1")
  run_test_case("print 'abc' < 'abd' ", "1")
  run_test_case("print 'abc' <= 'abd' ", "1")
  run_test_case("print 'abc' = 'ab' + 'c' ", "1")
  run_test_case("print 'abc' != 'abc' ", "0")
  run_test_case("print 'abc' != 'abd' ", "1")
  run_test_case("print 'Abc' != 'abc' ", "1")
  run_test_case("print 'Abc' = 'abc' ", "0")
  run_test_case("print 'a' = 'abc' ", "0")
  run_test_case("print 'a' != 'abc' ", "1")
  run_test_case("print 'a' > 'abc' ", "0")
  run_test_case("print 'a' >= 'abc' ", "0")
  run_test_case("print 'a' < 'abc' ", "1")
  run_test_case("print 'a' <= 'abc' ", "1")
  run_test_case("print (2, 3) = (2, 3)", "1")
  run_test_case("print (2, 3) = (3, 2)", "0")
  run_test_case("print (2, 3) <= (2, 3)", "1")
  run_test_case("print (3, 2) <= (2, 3)", "1")
  run_test_case("print (3, 2) <= (2, 3, 1)", "1")
  run_test_case("print (3, 2) < (2, 3, 1)", "1")
  run_test_case("print (3, 2) = (2, 3, 1)", "0")
  run_test_case("print (3, 2) != (2, 3, 1)", "1")
  run_test_case("print (3, 2) != (2, 3, 1)", "1")
  run_test_case("print (3, 2) >= (2, 3, 1)", "0")
  run_test_case("print (3, 2) > (2, 3, 1)", "0")
  run_test_case("print (1, 2, 3) > (2, 3, 1)", "0")
  run_test_case("print (1, 2, 3) >= (2, 3, 1)", "1")
  run_test_case("print (1, 2, 3) <= (2, 3, 1)", "1")
  run_test_case("print (1, 2, 3) != (2, 3, 1)", "1")
  run_test_case("print (1, 2, 3) = (1, 2, 3)", "1")
  run_test_case("print (1, 2, 3) = (1, 2, '3')", "1")
  run_test_case("print ('1', 2, 3) = (1, 2, '3')", "1")
  run_test_case("print (1, 2, 3) = (2, 3, 1)", "0")
  ...
  run_test_case("a = true; a = a xor true; print a", "0")
  ...
  run_test_case("aa = 3 june 2010; print aa", "3 June 2010")
  ...
  run_test_case("a = 12 june 2004; a { this + 1 day}", "13 June 2004")
  run_test_case("a = 2,3,4; a{print }", lines("2", "3", "4"))
  run_test_case("a = 2,3,4; a{this }", lines("2", "3", "4"))
  run_test_case("a = 2,3,4; a{1 + this * 2 }", lines("5", "7", "9"))
  run_test_case("2,3,4{3 + this * 2 }", lines("7", "9", "11"))
  run_test_case("2,'3',4{3 + this }", lines("32", "33", "34"))
  run_test_case("gh = 30, -2, 6, 3,23.3,1; gh order asc", lines("-2", "1", "3", "6", "23.3", "30"))
  run_test_case("gh = 30, -2, 6, 3,23.3,1; gh order by this asc", lines("-2", "1", "3", "6", "23.3", "30"))
  run_test_case("gh = 30, -2, 6, 3,23.3,1; gh order by this asc limit 5", lines("-2", "1", "3", "6", "23.3"))
  run_test_case("gh = 30, -2, 6, 3,23.3,1; gh order desc", lines("30", "23.3", "6", "3", "1", "-2"))
  run_test_case("gh = 30, -2, 6, 3,23.3,1; gh order by this desc", lines("30", "23.3", "6", "3", "1", "-2"))
  run_test_case("gh = 30, -2, 6, 3,23.3,1; gh order asc limit 3", lines("-2", "1", "3"))
  run_test_case("gh = 30, -2, 6, 3,23.3,1; gh order by absolute(this) asc", lines("1", "-2", "3", "6", "23.3", "30"))
  ...
  run_test_case("print number('4.32kb')", "0")
  run_test_case("print number('-123')", "-123")
  run_test_case("print number('--123')", "0")
  run_test_case("print number('-45.5')", "-45.5")
  run_test_case("print number('')", "0")
  run_test_case("print number('10k')", "0")
  run_test_case("print number('2mb')", "0")
  run_test_case("print number('2045')", "2045")
  run_test_case("print number(' 2045')", "0")
  run_test_case("print number('33 ')", "0")
  ...
  run_test_case("numbers(3 november 1996) { print this - 1000 }", lines("-997", "996"))
  ...
  run_test_case("u = 6,1,2,4,3,5; print u where this < 3.2", lines("1", "2", "3"))
  run_test_case("u = 6,1,2,4,3,5; print u where this >= 3", lines("6", "4", "3", "5"))
  run_test_case("u = 6,1,2,4,3,5; print u where this % 2 = 1", lines("1", "3", "5"))
  run_test_case("u = 6,1,2,4,3,5; print u where this + index = 7", lines("4", "3"))
  run_test_case("u = 6,1,2,4,3,5; print u skip 1 where this + index = 9", "5")
  run_test_case("u = 6,1,2,4,3,5; print u limit 1 where this + index != 7", "6")
  run_test_case("u = 6,1,2,4,3,5; print u final 3 where this < 4", "3")
  ...
  run_test_case("u = 6,1,2,4,3,5; print u order by this", lines("1", "2", "3", "4", "5", "6"))
  run_test_case("u = 6,1,2,4,3,5; print u order by this asc", lines("1", "2", "3", "4", "5", "6"))
  run_test_case("u = 6,1,2,4,3,5; print u order by this desc", lines("6", "5", "4", "3", "2", "1"))
  run_test_case("u = 6,1,2,4,3,5; print u order by -this asc", lines("6", "5", "4", "3", "2", "1"))
  ...
  run_test_case("x = -123.5, 18, -2, 50000, 3, 2.5, 100, -1500 ; print x order by length(this) desc, this asc", lines("-123.5", "-1500", "50000", "2.5", "100", "-2", "18", "3"))
  run_test_case("x = -123.5, 18, -2, 50000, 3, 2.5, 100, -1500 ; print x order by this desc, length(this) asc", lines("50000", "100", "18", "3", "2.5", "-2", "-123.5", "-1500"))
  ...
  lines("ghy", "auf")))
  (run_test_case("x = 2 april 2008, 1 june 2022, 6 june 2007, 19 january 2015, 11 june 2007; print x order desc",
  lines("1 June 2022", "19 January 2015", "2 April 2008", "11 June 2007", "6 June 2007")))
  (run_test_case("x = 2 april 2008, 1 june 2022, 6 june 2007, 19 january 2015, 11 june 2007; print x order by this.month desc, this desc",
  lines("1 June 2022", "11 June 2007", "6 June 2007", "2 April 2008", "19 January 2015")))
  (run_test_case("x = 2 april 2008, 1 june 2022, 6 june 2007, 19 january 2015, 11 june 2007; print x order by this.month desc, this.year asc, this.day desc",
  ...
  run_test_case("nl = 2,3,4; nl = nl, 6; print nl", lines("2", "3", "4", "6"))
  run_test_case("nl = 2,3,4; nl = nl, nl; print nl", lines("2", "3", "4", "2", "3", "4"))
  run_test_case("nl = 2,3,4; nl = nl, nl; print nl where this != 3", lines("2", "4", "2", "4"))
  run_test_case("nl = 2,3,4; nl = nl, nl; print nl where index != 3", lines("2", "3", "4", "3", "4"))
  run_test_case("li = 'b', 'c', 'd' ; print li[0], li[2]", lines("b", "d"))
  run_test_case("li = 'b', 'c', 'd' ; print li, 'just' ", lines("b", "c", "d", "just"))
  run_test_case("li = 'b', 'c', 'd' ; print 'just', li, 3+4 ", lines("just", "b", "c", "d", "7"))
  ...
  run_test_case(" 2 april 2010, 21 june 2012, 21 july 2006, newYear(2005) { this.year - this.day } ", lines("2008", "1991", "1985", "2004"))
  run_test_case(" 2 april 2010, 21 june 2012, 21 july 2006, newYear(2005) { if this.day = 21 {continue} this.year;  } ", lines("2010", "2005"))
  run_test_case(" 2 april 2010, 21 june 2012, 21 july 2006, newYear(2005) { if this.month = july {break} this.month;  } ", lines("4", "6"))
  ...
  run_test_case("inside 'tree' { print '*7*/*7*.cpp' order asc }", path("674295", "415734.cpp"))
  ...
  run_test_case("inside 'modificables' { create 'existing_empty_dir'}", "Failed to create 'existing_empty_dir'")
...
# run_test_case("inside 'modificables' { 'a.txt' { print parent(path) = location }}", "1")
  ...
  expect_syntax_error("print any(5 january 2011, 13:42)")
  expect_syntax_error("print any(5 years)")
  expect_syntax_error("print any(56)")
  expect_syntax_error("print any('56')")
  ...
  expect_syntax_error("print count(3)")
  expect_syntax_error("print count(3 days)")
  expect_syntax_error("print count(1 january 2000)")
  expect_syntax_error("print count('hey')")
  expect_syntax_error("print count('hey', 4)")
  expect_syntax_error("print count(2,3,4,5,6)")
  ...
  expect_syntax_error("s = 'hello'; s /= 2; s")
  expect_syntax_error("s = 'hello'; s %= 2; s")
  expect_syntax_error("nl = 2,3,4; nl[0] = 5; print nl")
  expect_syntax_error("nl = 2,3,4; nl[0] += 5; print nl")
  expect_syntax_error("nl = 2,3,4; nl += 5; print nl")
  expect_syntax_error("nl = 2,3,4; nl /= 5; print nl")
  expect_syntax_error("nl = 2,3,4; nl *= 5; print nl")
  expect_syntax_error("nl = 2,3,4; nl %= 5; print nl")
  expect_syntax_error("nl = 2,3,4; nl++; print nl")
  expect_syntax_error("nl = 2,3,4; nl--; print nl")
