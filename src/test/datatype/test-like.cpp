...
void test_like()
{
   testCase_like(1, L"p%", L"peru", true);
   testCase_like(2, L"b%", L"peru", false);
   ...
   testCase_like(29, L"%Perun2.txt", L"Perun2.txt", true);
   testCase_like(30, L"%Perun2.txt", L"TestPerun2.txt", true);
   testCase_like(31, L"%Perun2.txt", L"TestPerun2.txt.img", false);
   testCase_like(32, L"%Perun2.txt", L"Perun2.txt.img", false);
   testCase_like(33, L"%Perun2.txt", L"TestPerun2001.txt.img", false);
   testCase_like(34, L"Perun2.txt%", L"Perun2.txt", true);
   testCase_like(35, L"Perun2.txt%", L"TestPerun2.txt", false);
   testCase_like(36, L"Perun2.txt%", L"TestPerun2.txt.img", false);
   testCase_like(37, L"Perun2.txt%", L"Perun2.txt.img", true);
   testCase_like(38, L"Perun2.txt%", L"TestPerun2001.txt.img", false);
   testCase_like(39, L"%Perun2.txt%", L"Perun2.txt", true);
   testCase_like(40, L"%Perun2.txt%", L"TestPerun2.txt", true);
   testCase_like(41, L"%Perun2.txt%", L"TestPerun2.txt.img", true);
   testCase_like(42, L"%Perun2.txt%", L"Perun2.txt.img", true);
   testCase_like(43, L"%Perun2.txt%", L"TestPerun2001.txt.img", false);
   testCase_like(44, L"%Perun2%.txt", L"Perun2.txt", true);
   testCase_like(45, L"%Perun2%.txt", L"TestPerun2.txt", true);
   testCase_like(46, L"%Perun2%.txt", L"TestPerun2.txt.img", false);
   testCase_like(47, L"%Perun2%.txt", L"Perun2.txt.img", false);
   testCase_like(48, L"%Perun2%.txt", L"TestPerun2001.txt.img", false);
   testCase_like(49, L"%Perun2%.txt", L"TestPerun2001.txt", true);
   testCase_like(50, L"Perun2%.txt%", L"Perun2.txt", true);
   testCase_like(51, L"Perun2%.txt%", L"TestPerun2.txt", false);
   testCase_like(52, L"Perun2%.txt%", L"TestPerun2.txt.img", false);
   testCase_like(53, L"Perun2%.txt%", L"Perun2.txt.img", true);
   testCase_like(54, L"Perun2%.txt%", L"TestPerun2001.txt.img", false);
   testCase_like(55, L"Perun2%.txt%", L"TestPerun2001.txt", false);
   testCase_like(56, L"%Perun2%.txt%", L"Perun2.txt", true);
   testCase_like(57, L"%Perun2%.txt%", L"TestPerun2.txt", true);
   testCase_like(58, L"%Perun2%.txt%", L"TestPerun2.txt.img", true);
   testCase_like(59, L"%Perun2%.txt%", L"Perun2.txt.img", true);
   testCase_like(60, L"%Perun2%.txt%", L"TestPerun2001.txt.img", true);
   testCase_like(61, L"%Perun2%.txt%", L"TestPerun2001.txt", true);
   testCase_like(62, L"_Perun2_.txt_", L"1Perun23.txt4", true);
   testCase_like(63, L"_Perun2_.txt_", L"1Perun2.txt4", false);
   testCase_like(64, L"_Perun2_.txt_", L"1Perun23.txt", false);
   testCase_like(65, L"_Perun2_.txt_", L"Perun23.txt4", false);
   ...
   testCase_like(80, L"pe#b#r#s", L"pe0b0r0s", true);
   testCase_like(81, L"pe#b#r#s", L"pe0b0ros", false);
