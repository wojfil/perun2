...
TokenValue::TokenValue(const _num& n, const p_size os_id, const p_size os_len, const NumberMode nm)
...
Token::Token(const _num& v, const p_int li, const p_size os_id, const p_size os_len,
