...
p_int Tokens::getFilterKeywordId(pp_perun2& p2) const
{
   BracketsInfo bi;
...
std::vector<Tokens> Tokens::splitByFiltherKeywords(pp_perun2& p2) const
{
   std::vector<Tokens> result;
   BracketsInfo bi;
   p_int sublen = 0;
...
void Tokens::checkCommonExpressionExceptions(pp_perun2& p2) const
{
