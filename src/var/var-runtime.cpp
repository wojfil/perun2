...
Variables::Variables(uro::Uroboros& uro)
   ...
   inner(os_trim(uro.arguments.getLocation()), str(os_quoteEmbraced(this->uroPath), FLAG_SILENT_STR)),
   boo ({
   ...
   })
   {
      ...
      _genptr<_str> temp_root(new gen::Constant<_str>(this->inner.location.value));
